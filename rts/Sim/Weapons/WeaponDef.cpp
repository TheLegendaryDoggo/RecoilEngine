...
WEAPONTAG(float, salvoOffset).defaultValue(0.0f).description("Missile only. Lateral elmo offset applied to the target point, alternating sides per weapon slot. Spreads paired/slaved missiles so they impact apart instead of converging.");
